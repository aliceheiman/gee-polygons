...
**New Features:** - Added
[`Site.from_geodataframe_row()`](https://aliceheiman.github.io/gee-polygons/site.html#site.from_geodataframe_row)
to create a Site from a GeoDataFrame row - Added
[`sites_from_geodataframe()`](https://aliceheiman.github.io/gee-polygons/site.html#sites_from_geodataframe)
to create Sites from a filtered/sorted GeoDataFrame - Enables workflow:
...
for batch operations with chunking - Export to Google Drive and Cloud
Storage
...
class for polygon-first GEE analysis -
[`load_sites()`](https://aliceheiman.github.io/gee-polygons/core.html#load_sites)
to load sites from GeoJSON with automatic CRS detection - Pre-configured
layers: MapBiomas, Dynamic World, Sentinel-2 - Categorical and
